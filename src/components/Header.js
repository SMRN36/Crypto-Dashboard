...
export class Header extends Component {
    render() {
        return (
            <div>
                <nav className="navbar navbar-expand-lg" style={{backgroundColor:"#335c8c"}}>
                    <div className="container-fluid">
                        ...
                        <a className="navbar-brand d-flex ml-auto display-2 text-light fs-2 fw-bold text-uppercase  "
                            style={{ fontFamily: 'Goudy Old Style', color: "#ffffff"}} href="/">Crypto 
                            Dashboard</a>
